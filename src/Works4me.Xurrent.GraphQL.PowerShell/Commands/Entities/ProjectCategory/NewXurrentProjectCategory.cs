...
{
    /// <summary>
    /// Creates a new <see cref="ProjectCategory"/> through the Xurrent GraphQL API.<br/>
    /// This cmdlet constructs a <see cref="ProjectCategoryCreateInput"/> from the provided parameters, executes the operation, and returns a <see cref="ProjectCategoryCreatePayload"/> describing the result.<br/>
    /// </summary>
    [Cmdlet(VerbsCommon.New, "XurrentProjectCategory")]
    [OutputType(typeof(ProjectCategoryCreatePayload))]
    public class NewXurrentProjectCategory : XurrentCmdletBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Specifies the <see cref="ProjectCategoryQuery"/> that defines which fields of the <see cref="ProjectCategoryCreatePayload"/> are returned by the mutation.<br/>
        ...
        /// <summary>
        /// Executes the mutation by constructing a <see cref="ProjectCategoryCreateInput"/> from the bound parameters, submitting it with the provided or default client, and writing the resulting <see cref="ProjectCategoryCreatePayload"/> to the pipeline.<br/>
        /// Throws a terminating error if the request fails.<br/>
        /// </summary>
        protected override void OnProcessRecord()
        {
            ProjectCategoryCreateInput input = new();
            ...
            try
            {
                ...
                ProjectCategoryCreatePayload result = client.Client.MutationAsync(input, ResponseQuery).GetAwaiter().GetResult();
                WriteObject(result, false);
            }
            catch (XurrentException ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(NewXurrentProjectCategory), ErrorCategory.NotSpecified, this));
            }
            catch (Exception ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(NewXurrentProjectCategory), ErrorCategory.NotSpecified, this));
