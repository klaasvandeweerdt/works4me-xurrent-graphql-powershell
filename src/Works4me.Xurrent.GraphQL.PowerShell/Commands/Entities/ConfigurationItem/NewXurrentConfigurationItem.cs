...
{
    /// <summary>
    /// Creates a new <see cref="ConfigurationItem"/> through the Xurrent GraphQL API.<br/>
    /// This cmdlet constructs a <see cref="ConfigurationItemCreateInput"/> from the provided parameters, executes the operation, and returns a <see cref="ConfigurationItemCreatePayload"/> describing the result.<br/>
    /// </summary>
    [Cmdlet(VerbsCommon.New, "XurrentConfigurationItem")]
    [OutputType(typeof(ConfigurationItemCreatePayload))]
    public class NewXurrentConfigurationItem : XurrentCmdletBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Specifies the <see cref="ConfigurationItemQuery"/> that defines which fields of the <see cref="ConfigurationItemCreatePayload"/> are returned by the mutation.<br/>
        ...
        /// <summary>
        /// Executes the mutation by constructing a <see cref="ConfigurationItemCreateInput"/> from the bound parameters, submitting it with the provided or default client, and writing the resulting <see cref="ConfigurationItemCreatePayload"/> to the pipeline.<br/>
        ...
        protected override void OnProcessRecord()
        {
            ...
            try
            {
                ...
                ConfigurationItemCreatePayload result = client.Client.MutationAsync(input, ResponseQuery).GetAwaiter().GetResult();
                WriteObject(result, false);
            }
            catch (XurrentException ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(NewXurrentConfigurationItem), ErrorCategory.NotSpecified, this));
            }
            catch (Exception ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(NewXurrentConfigurationItem), ErrorCategory.NotSpecified, this));
