...
{
    /// <summary>
    /// Updates an existing <see cref="TimeEntry"/> through the Xurrent GraphQL API.<br/>
    /// This cmdlet constructs a <see cref="TimeEntryUpdateInput"/> from the provided parameters, executes the operation, and returns a <see cref="TimeEntryUpdatePayload"/> describing the result.<br/>
    /// </summary>
    [Cmdlet(VerbsCommon.Set, "XurrentTimeEntry")]
    [OutputType(typeof(TimeEntryUpdatePayload))]
    public class SetXurrentTimeEntry : XurrentCmdletBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Specifies the <see cref="TimeEntryQuery"/> that defines which fields of the <see cref="TimeEntryUpdatePayload"/> are returned by the mutation.<br/>
        ...
        /// <summary>
        /// Executes the mutation by constructing a <see cref="TimeEntryUpdateInput"/> from the bound parameters, submitting it with the provided or default client, and writing the resulting <see cref="TimeEntryUpdatePayload"/> to the pipeline.<br/>
        /// Throws a terminating error if the request fails.<br/>
        /// </summary>
        protected override void OnProcessRecord()
        {
            TimeEntryUpdateInput input = new();
            ...
            try
            {
                ...
                TimeEntryUpdatePayload result = client.Client.MutationAsync(input, ResponseQuery).GetAwaiter().GetResult();
                WriteObject(result, false);
            }
            catch (XurrentException ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(SetXurrentTimeEntry), ErrorCategory.NotSpecified, this));
            }
            catch (Exception ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(SetXurrentTimeEntry), ErrorCategory.NotSpecified, this));
