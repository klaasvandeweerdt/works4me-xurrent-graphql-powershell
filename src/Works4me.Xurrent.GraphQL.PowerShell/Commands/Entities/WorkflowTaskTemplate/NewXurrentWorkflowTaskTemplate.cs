...
{
    /// <summary>
    /// Creates a new <see cref="WorkflowTaskTemplate"/> through the Xurrent GraphQL API.<br/>
    /// This cmdlet constructs a <see cref="WorkflowTaskTemplateCreateInput"/> from the provided parameters, executes the operation, and returns a <see cref="WorkflowTaskTemplateCreatePayload"/> describing the result.<br/>
    /// </summary>
    [Cmdlet(VerbsCommon.New, "XurrentWorkflowTaskTemplate")]
    [OutputType(typeof(WorkflowTaskTemplateCreatePayload))]
    public class NewXurrentWorkflowTaskTemplate : XurrentCmdletBase
    {
        /// <summary>
        ...
        public bool? CopyNotesToRequest { get; set; }
        ...
        /// <summary>
        /// Specifies the <see cref="WorkflowTaskTemplateQuery"/> that defines which fields of the <see cref="WorkflowTaskTemplateCreatePayload"/> are returned by the mutation.<br/>
        ...
        /// <summary>
        /// Executes the mutation by constructing a <see cref="WorkflowTaskTemplateCreateInput"/> from the bound parameters, submitting it with the provided or default client, and writing the resulting <see cref="WorkflowTaskTemplateCreatePayload"/> to the pipeline.<br/>
        /// Throws a terminating error if the request fails.<br/>
        /// </summary>
        protected override void OnProcessRecord()
        {
            WorkflowTaskTemplateCreateInput input = new();
            ...
            if (MyInvocation.BoundParameters.ContainsKey(nameof(CopyNotesToRequest)))
                input.CopyNotesToRequest = CopyNotesToRequest;
            ...
            try
            {
                ...
                WorkflowTaskTemplateCreatePayload result = client.Client.MutationAsync(input, ResponseQuery).GetAwaiter().GetResult();
                WriteObject(result, false);
            }
            catch (XurrentException ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(NewXurrentWorkflowTaskTemplate), ErrorCategory.NotSpecified, this));
            }
            catch (Exception ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(NewXurrentWorkflowTaskTemplate), ErrorCategory.NotSpecified, this));
