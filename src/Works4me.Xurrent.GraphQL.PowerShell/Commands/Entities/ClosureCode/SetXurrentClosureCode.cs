...
{
    /// <summary>
    /// Updates an existing <see cref="ClosureCode"/> through the Xurrent GraphQL API.<br/>
    /// This cmdlet constructs a <see cref="ClosureCodeUpdateInput"/> from the provided parameters, executes the operation, and returns a <see cref="ClosureCodeUpdatePayload"/> describing the result.<br/>
    /// </summary>
    [Cmdlet(VerbsCommon.Set, "XurrentClosureCode")]
    [OutputType(typeof(ClosureCodeUpdatePayload))]
    public class SetXurrentClosureCode : XurrentCmdletBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Specifies the <see cref="ClosureCodeQuery"/> that defines which fields of the <see cref="ClosureCodeUpdatePayload"/> are returned by the mutation.<br/>
        ...
        /// <summary>
        /// Executes the mutation by constructing a <see cref="ClosureCodeUpdateInput"/> from the bound parameters, submitting it with the provided or default client, and writing the resulting <see cref="ClosureCodeUpdatePayload"/> to the pipeline.<br/>
        /// Throws a terminating error if the request fails.<br/>
        /// </summary>
        protected override void OnProcessRecord()
        {
            ClosureCodeUpdateInput input = new();
            ...
            try
            {
                ...
                ClosureCodeUpdatePayload result = client.Client.MutationAsync(input, ResponseQuery).GetAwaiter().GetResult();
                WriteObject(result, false);
            }
            catch (XurrentException ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(SetXurrentClosureCode), ErrorCategory.NotSpecified, this));
            }
            catch (Exception ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(SetXurrentClosureCode), ErrorCategory.NotSpecified, this));
