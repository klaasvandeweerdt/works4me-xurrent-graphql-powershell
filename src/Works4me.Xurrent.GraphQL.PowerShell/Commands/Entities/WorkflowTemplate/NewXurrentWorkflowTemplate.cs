...
{
    /// <summary>
    /// Creates a new <see cref="WorkflowTemplate"/> through the Xurrent GraphQL API.<br/>
    /// This cmdlet constructs a <see cref="WorkflowTemplateCreateInput"/> from the provided parameters, executes the operation, and returns a <see cref="WorkflowTemplateCreatePayload"/> describing the result.<br/>
    /// </summary>
    [Cmdlet(VerbsCommon.New, "XurrentWorkflowTemplate")]
    [OutputType(typeof(WorkflowTemplateCreatePayload))]
    public class NewXurrentWorkflowTemplate : XurrentCmdletBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Specifies the <see cref="WorkflowTemplateQuery"/> that defines which fields of the <see cref="WorkflowTemplateCreatePayload"/> are returned by the mutation.<br/>
        ...
        /// <summary>
        /// Executes the mutation by constructing a <see cref="WorkflowTemplateCreateInput"/> from the bound parameters, submitting it with the provided or default client, and writing the resulting <see cref="WorkflowTemplateCreatePayload"/> to the pipeline.<br/>
        ...
        protected override void OnProcessRecord()
        {
            ...
            try
            {
                ...
                WorkflowTemplateCreatePayload result = client.Client.MutationAsync(input, ResponseQuery).GetAwaiter().GetResult();
                WriteObject(result, false);
            }
            catch (XurrentException ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(NewXurrentWorkflowTemplate), ErrorCategory.NotSpecified, this));
            }
            catch (Exception ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(NewXurrentWorkflowTemplate), ErrorCategory.NotSpecified, this));
