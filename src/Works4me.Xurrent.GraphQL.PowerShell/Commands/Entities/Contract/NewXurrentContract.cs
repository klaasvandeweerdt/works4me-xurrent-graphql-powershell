...
{
    /// <summary>
    /// Creates a new <see cref="Contract"/> through the Xurrent GraphQL API.<br/>
    /// This cmdlet constructs a <see cref="ContractCreateInput"/> from the provided parameters, executes the operation, and returns a <see cref="ContractCreatePayload"/> describing the result.<br/>
    /// </summary>
    [Cmdlet(VerbsCommon.New, "XurrentContract")]
    [OutputType(typeof(ContractCreatePayload))]
    public class NewXurrentContract : XurrentCmdletBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Specifies the <see cref="ContractQuery"/> that defines which fields of the <see cref="ContractCreatePayload"/> are returned by the mutation.<br/>
        ...
        /// <summary>
        /// Executes the mutation by constructing a <see cref="ContractCreateInput"/> from the bound parameters, submitting it with the provided or default client, and writing the resulting <see cref="ContractCreatePayload"/> to the pipeline.<br/>
        ...
        protected override void OnProcessRecord()
        {
            ...
            try
            {
                ...
                ContractCreatePayload result = client.Client.MutationAsync(input, ResponseQuery).GetAwaiter().GetResult();
                WriteObject(result, false);
            }
            catch (XurrentException ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(NewXurrentContract), ErrorCategory.NotSpecified, this));
            }
            catch (Exception ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(NewXurrentContract), ErrorCategory.NotSpecified, this));
