...
{
    /// <summary>
    /// Creates a new <see cref="TimesheetSetting"/> through the Xurrent GraphQL API.<br/>
    /// This cmdlet constructs a <see cref="TimesheetSettingCreateInput"/> from the provided parameters, executes the operation, and returns a <see cref="TimesheetSettingCreatePayload"/> describing the result.<br/>
    /// </summary>
    [Cmdlet(VerbsCommon.New, "XurrentTimesheetSetting")]
    [OutputType(typeof(TimesheetSettingCreatePayload))]
    public class NewXurrentTimesheetSetting : XurrentCmdletBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Specifies the <see cref="TimesheetSettingQuery"/> that defines which fields of the <see cref="TimesheetSettingCreatePayload"/> are returned by the mutation.<br/>
        ...
        /// <summary>
        /// Executes the mutation by constructing a <see cref="TimesheetSettingCreateInput"/> from the bound parameters, submitting it with the provided or default client, and writing the resulting <see cref="TimesheetSettingCreatePayload"/> to the pipeline.<br/>
        ...
        protected override void OnProcessRecord()
        {
            ...
            try
            {
                ...
                TimesheetSettingCreatePayload result = client.Client.MutationAsync(input, ResponseQuery).GetAwaiter().GetResult();
                WriteObject(result, false);
            }
            catch (XurrentException ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(NewXurrentTimesheetSetting), ErrorCategory.NotSpecified, this));
            }
            catch (Exception ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(NewXurrentTimesheetSetting), ErrorCategory.NotSpecified, this));
