...
{
    /// <summary>
    /// Updates an existing <see cref="Team"/> through the Xurrent GraphQL API.<br/>
    /// This cmdlet constructs a <see cref="TeamUpdateInput"/> from the provided parameters, executes the operation, and returns a <see cref="TeamUpdatePayload"/> describing the result.<br/>
    /// </summary>
    [Cmdlet(VerbsCommon.Set, "XurrentTeam")]
    [OutputType(typeof(TeamUpdatePayload))]
    public class SetXurrentTeam : XurrentCmdletBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Specifies the <see cref="TeamQuery"/> that defines which fields of the <see cref="TeamUpdatePayload"/> are returned by the mutation.<br/>
        ...
        /// <summary>
        /// Executes the mutation by constructing a <see cref="TeamUpdateInput"/> from the bound parameters, submitting it with the provided or default client, and writing the resulting <see cref="TeamUpdatePayload"/> to the pipeline.<br/>
        /// Throws a terminating error if the request fails.<br/>
        /// </summary>
        protected override void OnProcessRecord()
        {
            TeamUpdateInput input = new();
            ...
            try
            {
                ...
                TeamUpdatePayload result = client.Client.MutationAsync(input, ResponseQuery).GetAwaiter().GetResult();
                WriteObject(result, false);
            }
            catch (XurrentException ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(SetXurrentTeam), ErrorCategory.NotSpecified, this));
            }
            catch (Exception ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(SetXurrentTeam), ErrorCategory.NotSpecified, this));
