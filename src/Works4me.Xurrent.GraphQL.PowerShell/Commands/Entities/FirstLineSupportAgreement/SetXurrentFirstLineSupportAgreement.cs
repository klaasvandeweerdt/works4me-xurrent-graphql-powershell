...
{
    /// <summary>
    /// Updates an existing <see cref="FirstLineSupportAgreement"/> through the Xurrent GraphQL API.<br/>
    /// This cmdlet constructs a <see cref="FirstLineSupportAgreementUpdateInput"/> from the provided parameters, executes the operation, and returns a <see cref="FirstLineSupportAgreementUpdatePayload"/> describing the result.<br/>
    /// </summary>
    [Cmdlet(VerbsCommon.Set, "XurrentFirstLineSupportAgreement")]
    [OutputType(typeof(FirstLineSupportAgreementUpdatePayload))]
    public class SetXurrentFirstLineSupportAgreement : XurrentCmdletBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Specifies the <see cref="FirstLineSupportAgreementQuery"/> that defines which fields of the <see cref="FirstLineSupportAgreementUpdatePayload"/> are returned by the mutation.<br/>
        ...
        /// <summary>
        /// Executes the mutation by constructing a <see cref="FirstLineSupportAgreementUpdateInput"/> from the bound parameters, submitting it with the provided or default client, and writing the resulting <see cref="FirstLineSupportAgreementUpdatePayload"/> to the pipeline.<br/>
        ...
        protected override void OnProcessRecord()
        {
            ...
            try
            {
                ...
                FirstLineSupportAgreementUpdatePayload result = client.Client.MutationAsync(input, ResponseQuery).GetAwaiter().GetResult();
                WriteObject(result, false);
            }
            catch (XurrentException ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(SetXurrentFirstLineSupportAgreement), ErrorCategory.NotSpecified, this));
            }
            catch (Exception ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(SetXurrentFirstLineSupportAgreement), ErrorCategory.NotSpecified, this));
