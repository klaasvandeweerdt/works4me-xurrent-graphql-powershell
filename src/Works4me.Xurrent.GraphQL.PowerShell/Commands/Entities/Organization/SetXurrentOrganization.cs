...
{
    /// <summary>
    /// Updates an existing <see cref="Organization"/> through the Xurrent GraphQL API.<br/>
    /// This cmdlet constructs a <see cref="OrganizationUpdateInput"/> from the provided parameters, executes the operation, and returns a <see cref="OrganizationUpdatePayload"/> describing the result.<br/>
    /// </summary>
    [Cmdlet(VerbsCommon.Set, "XurrentOrganization")]
    [OutputType(typeof(OrganizationUpdatePayload))]
    public class SetXurrentOrganization : XurrentCmdletBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Specifies the <see cref="OrganizationQuery"/> that defines which fields of the <see cref="OrganizationUpdatePayload"/> are returned by the mutation.<br/>
        ...
        /// <summary>
        /// Executes the mutation by constructing a <see cref="OrganizationUpdateInput"/> from the bound parameters, submitting it with the provided or default client, and writing the resulting <see cref="OrganizationUpdatePayload"/> to the pipeline.<br/>
        /// Throws a terminating error if the request fails.<br/>
        /// </summary>
        protected override void OnProcessRecord()
        {
            OrganizationUpdateInput input = new();
            ...
            try
            {
                ...
                OrganizationUpdatePayload result = client.Client.MutationAsync(input, ResponseQuery).GetAwaiter().GetResult();
                WriteObject(result, false);
            }
            catch (XurrentException ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(SetXurrentOrganization), ErrorCategory.NotSpecified, this));
            }
            catch (Exception ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(SetXurrentOrganization), ErrorCategory.NotSpecified, this));
