...
{
    /// <summary>
    /// Updates an existing <see cref="ServiceInstance"/> through the Xurrent GraphQL API.<br/>
    /// This cmdlet constructs a <see cref="ServiceInstanceUpdateInput"/> from the provided parameters, executes the operation, and returns a <see cref="ServiceInstanceUpdatePayload"/> describing the result.<br/>
    /// </summary>
    [Cmdlet(VerbsCommon.Set, "XurrentServiceInstance")]
    [OutputType(typeof(ServiceInstanceUpdatePayload))]
    public class SetXurrentServiceInstance : XurrentCmdletBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Specifies the <see cref="ServiceInstanceQuery"/> that defines which fields of the <see cref="ServiceInstanceUpdatePayload"/> are returned by the mutation.<br/>
        ...
        /// <summary>
        /// Executes the mutation by constructing a <see cref="ServiceInstanceUpdateInput"/> from the bound parameters, submitting it with the provided or default client, and writing the resulting <see cref="ServiceInstanceUpdatePayload"/> to the pipeline.<br/>
        /// Throws a terminating error if the request fails.<br/>
        /// </summary>
        protected override void OnProcessRecord()
        {
            ServiceInstanceUpdateInput input = new();
            ...
            try
            {
                ...
                ServiceInstanceUpdatePayload result = client.Client.MutationAsync(input, ResponseQuery).GetAwaiter().GetResult();
                WriteObject(result, false);
            }
            catch (XurrentException ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(SetXurrentServiceInstance), ErrorCategory.NotSpecified, this));
            }
            catch (Exception ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(SetXurrentServiceInstance), ErrorCategory.NotSpecified, this));
