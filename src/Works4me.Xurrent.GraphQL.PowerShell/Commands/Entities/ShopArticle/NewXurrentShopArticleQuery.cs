...
{
    /// <summary>
    /// Creates a new <see cref="ShopArticleQuery"/> object for building Xurrent <see cref="ShopArticle"/> queries.<br/>
    /// This cmdlet is used to define the fields, filters, sorting, and related objects to include when querying <see cref="ShopArticle"/> data through the Xurrent GraphQL API.<br/>
    /// </summary>
    [Cmdlet(VerbsCommon.New, "XurrentShopArticleQuery")]
    [OutputType(typeof(ShopArticleQuery))]
    public class NewXurrentShopArticleQuery : XurrentCmdletBase
    {
        /// <summary>
        /// Specifies the <see cref="ShopArticle"/> fields to include in the query result.<br/>
        /// This parameter is mandatory and determines which <see cref="ShopArticle"/> data is returned from the Xurrent GraphQL API.<br/>
        /// </summary>
        ...
        /// <summary>
        /// Filters the query to return only the <see cref="ShopArticle"/> with the specified identifier.<br/>
        ...
        /// <summary>
        /// Selects a predefined <see cref="ShopArticle"/> view for the <see cref="ShopArticleQuery"/>.<br/>
        /// A view represents a predefined projection that controls how <see cref="ShopArticle"/> data is returned from the Xurrent GraphQL API.<br/>
        /// </summary>
        [Parameter(Mandatory = false, Position = 2, ValueFromPipelineByPropertyName = true)]
        [ValidateNotNull]
        public ShopArticleView? View { get; set; }

        /// <summary>
        /// Specifies the field used to order <see cref="ShopArticle"/> results in the <see cref="ShopArticleQuery"/>.<br/>
        /// Combine with <see cref="SortOrder"/> to control the sort direction.<br/>
        /// </summary>
        [Parameter(Mandatory = false, Position = 3, ValueFromPipelineByPropertyName = true)]
        [ValidateNotNull]
        public ShopArticleOrderField? OrderBy { get; set; }

        /// <summary>
        /// Specifies the sort direction when ordering <see cref="ShopArticle"/> results.<br/>
        /// If omitted, the <see cref="ShopArticleQuery"/> defaults to ascending order.<br/>
        /// </summary>
        ...
        /// <summary>
        /// Sets the maximum number of <see cref="ShopArticle"/> items returned per request in the <see cref="ShopArticleQuery"/>.<br/>
        ...
        /// <summary>
        /// Includes a nested <see cref="AccountQuery"/> in the <see cref="ShopArticleQuery"/>, allowing related <see cref="Account"/> data to be retrieved as part of the query.
        /// </summary>
        ...
        /// <summary>
        /// Includes a nested <see cref="CalendarQuery"/> in the <see cref="ShopArticleQuery"/>, allowing related <see cref="Calendar"/> data to be retrieved as part of the query.
        /// </summary>
        ...
        /// <summary>
        /// Includes a nested <see cref="ShopArticleCategoryQuery"/> in the <see cref="ShopArticleQuery"/>, allowing related <see cref="ShopArticleCategory"/> data to be retrieved as part of the query.
        /// </summary>
        [Parameter(Mandatory = false, Position = 8, ValueFromPipelineByPropertyName = true)]
        [ValidateNotNull]
        public ShopArticleCategoryQuery? Category { get; set; }

        /// <summary>
        /// Includes a nested <see cref="RequestTemplateQuery"/> in the <see cref="ShopArticleQuery"/>, allowing related <see cref="RequestTemplate"/> data to be retrieved as part of the query.
        /// </summary>
        ...
        /// <summary>
        /// Includes a nested <see cref="ProductQuery"/> in the <see cref="ShopArticleQuery"/>, allowing related <see cref="Product"/> data to be retrieved as part of the query.
        /// </summary>
        ...
        /// <summary>
        /// Includes a nested <see cref="ProviderShopArticleQuery"/> in the <see cref="ShopArticleQuery"/>, allowing related <see cref="ProviderShopArticle"/> data to be retrieved as part of the query.
        /// </summary>
        ...
        /// Builds a <see cref="ShopArticleQuery"/> based on the provided parameters and writes the configured query object to the pipeline.<br/>
        /// </summary>
        protected override void OnProcessRecord()
        {
            ShopArticleQuery query = new();
            ...
            {
                foreach (QueryFilter<ShopArticleFilterField> filter in Filters)
                {
