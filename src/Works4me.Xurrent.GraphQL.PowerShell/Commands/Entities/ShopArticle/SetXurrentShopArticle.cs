...
{
    /// <summary>
    /// Updates an existing <see cref="ShopArticle"/> through the Xurrent GraphQL API.<br/>
    /// This cmdlet constructs a <see cref="ShopArticleUpdateInput"/> from the provided parameters, executes the operation, and returns a <see cref="ShopArticleUpdatePayload"/> describing the result.<br/>
    /// </summary>
    [Cmdlet(VerbsCommon.Set, "XurrentShopArticle")]
    [OutputType(typeof(ShopArticleUpdatePayload))]
    public class SetXurrentShopArticle : XurrentCmdletBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Executes the mutation by constructing a <see cref="ShopArticleUpdateInput"/> from the bound parameters, submitting it with the provided or default client, and writing the resulting <see cref="ShopArticleUpdatePayload"/> to the pipeline.<br/>
        ...
        protected override void OnProcessRecord()
        {
            ...
            try
            {
                ...
                ShopArticleUpdatePayload result = client.Client.MutationAsync(input, ResponseQuery).GetAwaiter().GetResult();
                WriteObject(result, false);
            }
            catch (XurrentException ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(SetXurrentShopArticle), ErrorCategory.NotSpecified, this));
            }
            catch (Exception ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(SetXurrentShopArticle), ErrorCategory.NotSpecified, this));
