...
{
    /// <summary>
    /// Creates a new <see cref="UiExtension"/> through the Xurrent GraphQL API.<br/>
    /// This cmdlet constructs a <see cref="UiExtensionCreateInput"/> from the provided parameters, executes the operation, and returns a <see cref="UiExtensionCreatePayload"/> describing the result.<br/>
    /// </summary>
    [Cmdlet(VerbsCommon.New, "XurrentUiExtension")]
    [OutputType(typeof(UiExtensionCreatePayload))]
    public class NewXurrentUiExtension : XurrentCmdletBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Specifies the <see cref="UiExtensionQuery"/> that defines which fields of the <see cref="UiExtensionCreatePayload"/> are returned by the mutation.<br/>
        ...
        /// <summary>
        /// Executes the mutation by constructing a <see cref="UiExtensionCreateInput"/> from the bound parameters, submitting it with the provided or default client, and writing the resulting <see cref="UiExtensionCreatePayload"/> to the pipeline.<br/>
        ...
        protected override void OnProcessRecord()
        {
            ...
            try
            {
                ...
                UiExtensionCreatePayload result = client.Client.MutationAsync(input, ResponseQuery).GetAwaiter().GetResult();
                WriteObject(result, false);
            }
            catch (XurrentException ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(NewXurrentUiExtension), ErrorCategory.NotSpecified, this));
            }
            catch (Exception ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(NewXurrentUiExtension), ErrorCategory.NotSpecified, this));
