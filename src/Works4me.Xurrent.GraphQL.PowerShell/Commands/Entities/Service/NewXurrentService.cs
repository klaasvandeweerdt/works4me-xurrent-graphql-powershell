...
{
    /// <summary>
    /// Creates a new <see cref="Service"/> through the Xurrent GraphQL API.<br/>
    /// This cmdlet constructs a <see cref="ServiceCreateInput"/> from the provided parameters, executes the operation, and returns a <see cref="ServiceCreatePayload"/> describing the result.<br/>
    /// </summary>
    [Cmdlet(VerbsCommon.New, "XurrentService")]
    [OutputType(typeof(ServiceCreatePayload))]
    public class NewXurrentService : XurrentCmdletBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Specifies the <see cref="ServiceQuery"/> that defines which fields of the <see cref="ServiceCreatePayload"/> are returned by the mutation.<br/>
        ...
        /// <summary>
        /// Executes the mutation by constructing a <see cref="ServiceCreateInput"/> from the bound parameters, submitting it with the provided or default client, and writing the resulting <see cref="ServiceCreatePayload"/> to the pipeline.<br/>
        ...
        protected override void OnProcessRecord()
        {
            ...
            try
            {
                ...
                ServiceCreatePayload result = client.Client.MutationAsync(input, ResponseQuery).GetAwaiter().GetResult();
                WriteObject(result, false);
            }
            catch (XurrentException ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(NewXurrentService), ErrorCategory.NotSpecified, this));
            }
            catch (Exception ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(NewXurrentService), ErrorCategory.NotSpecified, this));
