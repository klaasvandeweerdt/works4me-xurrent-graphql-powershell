...
{
    /// <summary>
    /// Creates a new <see cref="ProductBacklogQuery"/> object for building Xurrent <see cref="ProductBacklog"/> queries.<br/>
    /// This cmdlet is used to define the fields, filters, sorting, and related objects to include when querying <see cref="ProductBacklog"/> data through the Xurrent GraphQL API.<br/>
    /// </summary>
    [Cmdlet(VerbsCommon.New, "XurrentProductBacklogQuery")]
    [OutputType(typeof(ProductBacklogQuery))]
    public class NewXurrentProductBacklogQuery : XurrentCmdletBase
    {
        /// <summary>
        /// Specifies the <see cref="ProductBacklog"/> fields to include in the query result.<br/>
        /// This parameter is mandatory and determines which <see cref="ProductBacklog"/> data is returned from the Xurrent GraphQL API.<br/>
        /// </summary>
        ...
        /// <summary>
        /// Filters the query to return only the <see cref="ProductBacklog"/> with the specified identifier.<br/>
        ...
        /// <summary>
        /// Selects a predefined <see cref="ProductBacklog"/> view for the <see cref="ProductBacklogQuery"/>.<br/>
        /// A view represents a predefined projection that controls how <see cref="ProductBacklog"/> data is returned from the Xurrent GraphQL API.<br/>
        /// </summary>
        [Parameter(Mandatory = false, Position = 2, ValueFromPipelineByPropertyName = true)]
        [ValidateNotNull]
        public ProductBacklogView? View { get; set; }

        /// <summary>
        /// Specifies the field used to order <see cref="ProductBacklog"/> results in the <see cref="ProductBacklogQuery"/>.<br/>
        /// Combine with <see cref="SortOrder"/> to control the sort direction.<br/>
        /// </summary>
        [Parameter(Mandatory = false, Position = 3, ValueFromPipelineByPropertyName = true)]
        [ValidateNotNull]
        public ProductBacklogOrderField? OrderBy { get; set; }

        /// <summary>
        /// Specifies the sort direction when ordering <see cref="ProductBacklog"/> results.<br/>
        /// If omitted, the <see cref="ProductBacklogQuery"/> defaults to ascending order.<br/>
        /// </summary>
        ...
        /// <summary>
        /// Sets the maximum number of <see cref="ProductBacklog"/> items returned per request in the <see cref="ProductBacklogQuery"/>.<br/>
        ...
        /// <summary>
        /// Includes a nested <see cref="AccountQuery"/> in the <see cref="ProductBacklogQuery"/>, allowing related <see cref="Account"/> data to be retrieved as part of the query.
        /// </summary>
        ...
        /// <summary>
        /// Includes a nested <see cref="AttachmentQuery"/> in the <see cref="ProductBacklogQuery"/>, allowing related <see cref="Attachment"/> data to be retrieved as part of the query.
        /// </summary>
        ...
        /// <summary>
        /// Includes a nested <see cref="ProblemQuery"/> in the <see cref="ProductBacklogQuery"/>, allowing related Items data, cast to <see cref="Problem"/>, to be retrieved as part of the query.
        /// </summary>
        ...
        /// <summary>
        /// Includes a nested <see cref="RequestQuery"/> in the <see cref="ProductBacklogQuery"/>, allowing related Items data, cast to <see cref="Request"/>, to be retrieved as part of the query.
        /// </summary>
        [Parameter(Mandatory = false, Position = 8, ValueFromPipelineByPropertyName = true)]
        [ValidateNotNull]
        ...
        /// <summary>
        /// Includes a nested <see cref="PersonQuery"/> in the <see cref="ProductBacklogQuery"/>, allowing related <see cref="Person"/> data to be retrieved as part of the query.
        /// </summary>
        ...
        /// Builds a <see cref="ProductBacklogQuery"/> based on the provided parameters and writes the configured query object to the pipeline.<br/>
        /// </summary>
        protected override void OnProcessRecord()
        {
            ProductBacklogQuery query = new();
            ...
            {
                foreach (QueryFilter<ProductBacklogFilterField> filter in Filters)
                {
