...
{
    /// <summary>
    /// Creates a new <see cref="EffortClass"/> through the Xurrent GraphQL API.<br/>
    /// This cmdlet constructs a <see cref="EffortClassCreateInput"/> from the provided parameters, executes the operation, and returns a <see cref="EffortClassCreatePayload"/> describing the result.<br/>
    /// </summary>
    [Cmdlet(VerbsCommon.New, "XurrentEffortClass")]
    [OutputType(typeof(EffortClassCreatePayload))]
    public class NewXurrentEffortClass : XurrentCmdletBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Specifies the <see cref="EffortClassQuery"/> that defines which fields of the <see cref="EffortClassCreatePayload"/> are returned by the mutation.<br/>
        ...
        /// <summary>
        /// Executes the mutation by constructing a <see cref="EffortClassCreateInput"/> from the bound parameters, submitting it with the provided or default client, and writing the resulting <see cref="EffortClassCreatePayload"/> to the pipeline.<br/>
        /// Throws a terminating error if the request fails.<br/>
        /// </summary>
        protected override void OnProcessRecord()
        {
            EffortClassCreateInput input = new();
            ...
            try
            {
                ...
                EffortClassCreatePayload result = client.Client.MutationAsync(input, ResponseQuery).GetAwaiter().GetResult();
                WriteObject(result, false);
            }
            catch (XurrentException ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(NewXurrentEffortClass), ErrorCategory.NotSpecified, this));
            }
            catch (Exception ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(NewXurrentEffortClass), ErrorCategory.NotSpecified, this));
