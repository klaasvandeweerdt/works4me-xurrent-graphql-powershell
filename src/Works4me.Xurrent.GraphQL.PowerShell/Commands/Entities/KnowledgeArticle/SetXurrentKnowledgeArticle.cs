...
{
    /// <summary>
    /// Updates an existing <see cref="KnowledgeArticle"/> through the Xurrent GraphQL API.<br/>
    /// This cmdlet constructs a <see cref="KnowledgeArticleUpdateInput"/> from the provided parameters, executes the operation, and returns a <see cref="KnowledgeArticleUpdatePayload"/> describing the result.<br/>
    /// </summary>
    [Cmdlet(VerbsCommon.Set, "XurrentKnowledgeArticle")]
    [OutputType(typeof(KnowledgeArticleUpdatePayload))]
    public class SetXurrentKnowledgeArticle : XurrentCmdletBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Specifies the <see cref="KnowledgeArticleQuery"/> that defines which fields of the <see cref="KnowledgeArticleUpdatePayload"/> are returned by the mutation.<br/>
        ...
        /// <summary>
        /// Executes the mutation by constructing a <see cref="KnowledgeArticleUpdateInput"/> from the bound parameters, submitting it with the provided or default client, and writing the resulting <see cref="KnowledgeArticleUpdatePayload"/> to the pipeline.<br/>
        /// Throws a terminating error if the request fails.<br/>
        /// </summary>
        protected override void OnProcessRecord()
        {
            KnowledgeArticleUpdateInput input = new();
            ...
            try
            {
                ...
                KnowledgeArticleUpdatePayload result = client.Client.MutationAsync(input, ResponseQuery).GetAwaiter().GetResult();
                WriteObject(result, false);
            }
            catch (XurrentException ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(SetXurrentKnowledgeArticle), ErrorCategory.NotSpecified, this));
            }
            catch (Exception ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(SetXurrentKnowledgeArticle), ErrorCategory.NotSpecified, this));
