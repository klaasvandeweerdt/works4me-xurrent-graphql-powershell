...
{
    /// <summary>
    /// Updates an existing <see cref="ProjectTaskTemplate"/> through the Xurrent GraphQL API.<br/>
    /// This cmdlet constructs a <see cref="ProjectTaskTemplateUpdateInput"/> from the provided parameters, executes the operation, and returns a <see cref="ProjectTaskTemplateUpdatePayload"/> describing the result.<br/>
    /// </summary>
    [Cmdlet(VerbsCommon.Set, "XurrentProjectTaskTemplate")]
    [OutputType(typeof(ProjectTaskTemplateUpdatePayload))]
    public class SetXurrentProjectTaskTemplate : XurrentCmdletBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Specifies the <see cref="ProjectTaskTemplateQuery"/> that defines which fields of the <see cref="ProjectTaskTemplateUpdatePayload"/> are returned by the mutation.<br/>
        ...
        /// <summary>
        /// Executes the mutation by constructing a <see cref="ProjectTaskTemplateUpdateInput"/> from the bound parameters, submitting it with the provided or default client, and writing the resulting <see cref="ProjectTaskTemplateUpdatePayload"/> to the pipeline.<br/>
        /// Throws a terminating error if the request fails.<br/>
        /// </summary>
        protected override void OnProcessRecord()
        {
            ProjectTaskTemplateUpdateInput input = new();
            ...
            try
            {
                ...
                ProjectTaskTemplateUpdatePayload result = client.Client.MutationAsync(input, ResponseQuery).GetAwaiter().GetResult();
                WriteObject(result, false);
            }
            catch (XurrentException ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(SetXurrentProjectTaskTemplate), ErrorCategory.NotSpecified, this));
            }
            catch (Exception ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(SetXurrentProjectTaskTemplate), ErrorCategory.NotSpecified, this));
