...
{
    /// <summary>
    /// Creates a new <see cref="RequestTemplate"/> through the Xurrent GraphQL API.<br/>
    /// This cmdlet constructs a <see cref="RequestTemplateCreateInput"/> from the provided parameters, executes the operation, and returns a <see cref="RequestTemplateCreatePayload"/> describing the result.<br/>
    /// </summary>
    [Cmdlet(VerbsCommon.New, "XurrentRequestTemplate")]
    [OutputType(typeof(RequestTemplateCreatePayload))]
    public class NewXurrentRequestTemplate : XurrentCmdletBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Specifies the <see cref="RequestTemplateQuery"/> that defines which fields of the <see cref="RequestTemplateCreatePayload"/> are returned by the mutation.<br/>
        ...
        /// <summary>
        /// Executes the mutation by constructing a <see cref="RequestTemplateCreateInput"/> from the bound parameters, submitting it with the provided or default client, and writing the resulting <see cref="RequestTemplateCreatePayload"/> to the pipeline.<br/>
        ...
        protected override void OnProcessRecord()
        {
            ...
            if (MyInvocation.BoundParameters.ContainsKey(nameof(ActionType)))
            ...
            try
            {
                ...
                RequestTemplateCreatePayload result = client.Client.MutationAsync(input, ResponseQuery).GetAwaiter().GetResult();
                WriteObject(result, false);
            }
            catch (XurrentException ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(NewXurrentRequestTemplate), ErrorCategory.NotSpecified, this));
            }
            catch (Exception ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(NewXurrentRequestTemplate), ErrorCategory.NotSpecified, this));
