...
{
    /// <summary>
    /// Creates a new <see cref="AppOffering"/> through the Xurrent GraphQL API.<br/>
    /// This cmdlet constructs a <see cref="AppOfferingCreateInput"/> from the provided parameters, executes the operation, and returns a <see cref="AppOfferingCreatePayload"/> describing the result.<br/>
    /// </summary>
    [Cmdlet(VerbsCommon.New, "XurrentAppOffering")]
    [OutputType(typeof(AppOfferingCreatePayload))]
    public class NewXurrentAppOffering : XurrentCmdletBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Specifies the <see cref="AppOfferingQuery"/> that defines which fields of the <see cref="AppOfferingCreatePayload"/> are returned by the mutation.<br/>
        ...
        /// <summary>
        /// Executes the mutation by constructing a <see cref="AppOfferingCreateInput"/> from the bound parameters, submitting it with the provided or default client, and writing the resulting <see cref="AppOfferingCreatePayload"/> to the pipeline.<br/>
        ...
        protected override void OnProcessRecord()
        {
            ...
            try
            {
                ...
                AppOfferingCreatePayload result = client.Client.MutationAsync(input, ResponseQuery).GetAwaiter().GetResult();
                WriteObject(result, false);
            }
            catch (XurrentException ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(NewXurrentAppOffering), ErrorCategory.NotSpecified, this));
            }
            catch (Exception ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(NewXurrentAppOffering), ErrorCategory.NotSpecified, this));
