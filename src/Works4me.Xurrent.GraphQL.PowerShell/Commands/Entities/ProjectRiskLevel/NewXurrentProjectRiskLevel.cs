...
{
    /// <summary>
    /// Creates a new <see cref="ProjectRiskLevel"/> through the Xurrent GraphQL API.<br/>
    /// This cmdlet constructs a <see cref="ProjectRiskLevelCreateInput"/> from the provided parameters, executes the operation, and returns a <see cref="ProjectRiskLevelCreatePayload"/> describing the result.<br/>
    /// </summary>
    [Cmdlet(VerbsCommon.New, "XurrentProjectRiskLevel")]
    [OutputType(typeof(ProjectRiskLevelCreatePayload))]
    public class NewXurrentProjectRiskLevel : XurrentCmdletBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Specifies the <see cref="ProjectRiskLevelQuery"/> that defines which fields of the <see cref="ProjectRiskLevelCreatePayload"/> are returned by the mutation.<br/>
        ...
        /// <summary>
        /// Executes the mutation by constructing a <see cref="ProjectRiskLevelCreateInput"/> from the bound parameters, submitting it with the provided or default client, and writing the resulting <see cref="ProjectRiskLevelCreatePayload"/> to the pipeline.<br/>
        /// Throws a terminating error if the request fails.<br/>
        /// </summary>
        protected override void OnProcessRecord()
        {
            ProjectRiskLevelCreateInput input = new();
            ...
            try
            {
                ...
                ProjectRiskLevelCreatePayload result = client.Client.MutationAsync(input, ResponseQuery).GetAwaiter().GetResult();
                WriteObject(result, false);
            }
            catch (XurrentException ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(NewXurrentProjectRiskLevel), ErrorCategory.NotSpecified, this));
            }
            catch (Exception ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(NewXurrentProjectRiskLevel), ErrorCategory.NotSpecified, this));
