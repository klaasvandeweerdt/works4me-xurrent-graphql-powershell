...
{
    /// <summary>
    /// Creates a new <see cref="ProductQuery"/> object for building Xurrent <see cref="Product"/> queries.<br/>
    /// This cmdlet is used to define the fields, filters, sorting, and related objects to include when querying <see cref="Product"/> data through the Xurrent GraphQL API.<br/>
    /// </summary>
    [Cmdlet(VerbsCommon.New, "XurrentProductQuery")]
    [OutputType(typeof(ProductQuery))]
    public class NewXurrentProductQuery : XurrentCmdletBase
    {
        /// <summary>
        /// Specifies the <see cref="Product"/> fields to include in the query result.<br/>
        /// This parameter is mandatory and determines which <see cref="Product"/> data is returned from the Xurrent GraphQL API.<br/>
        /// </summary>
        ...
        /// <summary>
        /// Filters the query to return only the <see cref="Product"/> with the specified identifier.<br/>
        ...
        /// <summary>
        /// Selects a predefined <see cref="Product"/> view for the <see cref="ProductQuery"/>.<br/>
        /// A view represents a predefined projection that controls how <see cref="Product"/> data is returned from the Xurrent GraphQL API.<br/>
        /// </summary>
        ...
        /// <summary>
        /// Specifies the field used to order <see cref="Product"/> results in the <see cref="ProductQuery"/>.<br/>
        ...
        /// <summary>
        /// Specifies the sort direction when ordering <see cref="Product"/> results.<br/>
        /// If omitted, the <see cref="ProductQuery"/> defaults to ascending order.<br/>
        /// </summary>
        ...
        /// <summary>
        /// Sets the maximum number of <see cref="Product"/> items returned per request in the <see cref="ProductQuery"/>.<br/>
        ...
        /// <summary>
        /// Includes a nested <see cref="AccountQuery"/> in the <see cref="ProductQuery"/>, allowing related <see cref="Account"/> data to be retrieved as part of the query.
        /// </summary>
        ...
        /// <summary>
        /// Includes a nested <see cref="ConfigurationItemQuery"/> in the <see cref="ProductQuery"/>, allowing related <see cref="ConfigurationItem"/> data to be retrieved as part of the query.
        /// </summary>
        ...
        /// <summary>
        /// Includes a nested <see cref="CustomFieldQuery"/> in the <see cref="ProductQuery"/>, allowing related <see cref="CustomField"/> data to be retrieved as part of the query.
        /// </summary>
        ...
        /// <summary>
        /// Includes a nested <see cref="AttachmentQuery"/> in the <see cref="ProductQuery"/>, allowing related <see cref="Attachment"/> data to be retrieved as part of the query.
        /// </summary>
        ...
        /// <summary>
        /// Includes a nested <see cref="OrganizationQuery"/> in the <see cref="ProductQuery"/>, allowing related <see cref="Organization"/> data to be retrieved as part of the query.
        /// </summary>
        ...
        /// <summary>
        /// Includes a nested <see cref="ProductCategoryQuery"/> in the <see cref="ProductQuery"/>, allowing related <see cref="ProductCategory"/> data to be retrieved as part of the query.
        /// </summary>
        [Parameter(Mandatory = false, Position = 11, ValueFromPipelineByPropertyName = true)]
        [ValidateNotNull]
        public ProductCategoryQuery? ProductCategory { get; set; }

        /// <summary>
        /// Includes a nested <see cref="RecurrenceTemplateQuery"/> in the <see cref="ProductQuery"/>, allowing related <see cref="RecurrenceTemplate"/> data to be retrieved as part of the query.
        /// </summary>
        [Parameter(Mandatory = false, Position = 12, ValueFromPipelineByPropertyName = true)]
        [ValidateNotNull]
        public RecurrenceTemplateQuery? Recurrence { get; set; }
        ...
        /// <summary>
        /// Includes a nested <see cref="ServiceQuery"/> in the <see cref="ProductQuery"/>, allowing related <see cref="Service"/> data to be retrieved as part of the query.
        /// </summary>
        ...
        /// <summary>
        /// Includes a nested <see cref="TeamQuery"/> in the <see cref="ProductQuery"/>, allowing related <see cref="Team"/> data to be retrieved as part of the query.
        /// </summary>
        ...
        /// <summary>
        /// Includes a nested <see cref="UiExtensionQuery"/> in the <see cref="ProductQuery"/>, allowing related <see cref="UiExtension"/> data to be retrieved as part of the query.
        /// </summary>
        ...
        /// <summary>
        /// Includes a nested <see cref="PersonQuery"/> in the <see cref="ProductQuery"/>, allowing related <see cref="Person"/> data to be retrieved as part of the query.
        /// </summary>
        ...
        /// <summary>
        /// Includes a nested <see cref="WorkflowTemplateQuery"/> in the <see cref="ProductQuery"/>, allowing related <see cref="WorkflowTemplate"/> data to be retrieved as part of the query.
        /// </summary>
        ...
        /// <summary>
        /// Applies one or more <see cref="QueryFilter{ProductFilterField}"/> conditions to the <see cref="ProductQuery"/>.<br/>
        /// Filters restrict which <see cref="Product"/> data is returned from the Xurrent GraphQL API.<br/>
        /// </summary>
        [Parameter(Mandatory = false, Position = 20, ValueFromPipelineByPropertyName = true)]
        [ValidateNotNull]
        public QueryFilter<ProductFilterField>[]? Filters { get; set; }

        /// <summary>
        /// Adds a free-form search filter to the <see cref="ProductQuery"/>.<br/>
        /// This parameter enables simple text-based filtering of <see cref="Product"/> results.<br/>
        /// </summary>
        ...
        /// <summary>
        /// Filters the <see cref="Product"/> by custom fields marked as "Filterable" in their UI Extension.<br/>
        /// See the <see href="https://developer.xurrent.com/graphql/input_object/productcustomfilter/">Xurrent developer</see> site for details.<br/>
        /// </summary>
        ...
        /// Builds a <see cref="ProductQuery"/> based on the provided parameters and writes the configured query object to the pipeline.<br/>
        /// </summary>
        protected override void OnProcessRecord()
        {
            ...
            if (ProductCategory is not null && MyInvocation.BoundParameters.ContainsKey(nameof(ProductCategory)))
                query.SelectProductCategory(ProductCategory);
            ...
            {
                foreach (QueryFilter<ProductFilterField> filter in Filters)
                {
