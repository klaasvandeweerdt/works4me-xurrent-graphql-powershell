...
{
    /// <summary>
    /// Updates an existing <see cref="Product"/> through the Xurrent GraphQL API.<br/>
    /// This cmdlet constructs a <see cref="ProductUpdateInput"/> from the provided parameters, executes the operation, and returns a <see cref="ProductUpdatePayload"/> describing the result.<br/>
    /// </summary>
    [Cmdlet(VerbsCommon.Set, "XurrentProduct")]
    [OutputType(typeof(ProductUpdatePayload))]
    public class SetXurrentProduct : XurrentCmdletBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Specifies the <see cref="ProductQuery"/> that defines which fields of the <see cref="ProductUpdatePayload"/> are returned by the mutation.<br/>
        ...
        /// <summary>
        /// Executes the mutation by constructing a <see cref="ProductUpdateInput"/> from the bound parameters, submitting it with the provided or default client, and writing the resulting <see cref="ProductUpdatePayload"/> to the pipeline.<br/>
        /// Throws a terminating error if the request fails.<br/>
        /// </summary>
        protected override void OnProcessRecord()
        {
            ProductUpdateInput input = new();
            ...
            try
            {
                ...
                ProductUpdatePayload result = client.Client.MutationAsync(input, ResponseQuery).GetAwaiter().GetResult();
                WriteObject(result, false);
            }
            catch (XurrentException ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(SetXurrentProduct), ErrorCategory.NotSpecified, this));
            }
            catch (Exception ex)
            {
                ThrowTerminatingError(new ErrorRecord(ex, nameof(SetXurrentProduct), ErrorCategory.NotSpecified, this));
