...
{
    /// <summary>
    /// Creates a new <see cref="AgileBoard"/> through the Xurrent GraphQL API.<br/>
    /// This cmdlet constructs a <see cref="AgileBoardCreateInput"/> from the provided parameters, executes the operation, and returns a <see cref="AgileBoardCreatePayload"/> describing the result.<br/>
    /// </summary>
    [Cmdlet(VerbsCommon.New, "XurrentAgileBoard")]
    [OutputType(typeof(AgileBoardCreatePayload))]
    public class NewXurrentAgileBoard : XurrentCmdletBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Executes the mutation by constructing a <see cref="AgileBoardCreateInput"/> from the bound parameters, submitting it with the provided or default client, and writing the resulting <see cref="AgileBoardCreatePayload"/> to the pipeline.<br/>
        /// Throws a terminating error if the request fails.<br/>
        /// </summary>
        protected override void OnProcessRecord()
        {
            AgileBoardCreateInput input = new();
            ...
            try
            {
                ...
                AgileBoardCreatePayload result = client.Client.MutationAsync(input, ResponseQuery).GetAwaiter().GetResult();
